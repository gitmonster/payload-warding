...
export { Built, Label, Options, Populate, RolePopulate, UserPopulate } from "./factory/spec";
...
export { Label as SpecLabel, Labels as SpecLabels } from "./spec/definition/label";
